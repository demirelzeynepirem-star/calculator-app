// Package calculator evaluates math expressions without eval.
package calculator
...
// Error reports an input problem and its position.
type Error struct {
	Position int
	Message  string
}
...
// Evaluate calculates an expression with +, -, *, /, ^, brackets, and sqrt.
// Numbers can have signs; a trailing % divides the value by 100.
...
// Powers group from the right: 2^3^2 means 2^(3^2).
